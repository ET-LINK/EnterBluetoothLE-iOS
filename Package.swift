...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "EnterCombineBluetooth",
            dependencies: [
                .productItem(name: "NordicDFU", package: "IOS-Pods-DFU-Library", condition: nil),
                "CombineCoreBluetooth",
                "PromiseKit",
            ]),
        .testTarget(
            name: "EnterCombineBluetoothTests",
            dependencies: ["EnterCombineBluetooth"]),
    ]
)
